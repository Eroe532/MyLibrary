namespace EventSoursing.Events.CancelEvents;

/// <summary>
/// Событие аннулирования
/// </summary>
public class CancelEventsV1<Tmetadata> : Event<Tmetadata> where Tmetadata : IEventMetadata, ICloneMetadata<Tmetadata>, new()
{
    /// <summary>
